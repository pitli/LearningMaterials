...
![img](05.第一个 Spring Boot 应用程序.assets/073cc7b8542a62d.png)

### 填写项目信息

![img](05.第一个 Spring Boot 应用程序.assets/b5daca13b09a749.png)

### 选择版本和依赖

![img](05.第一个 Spring Boot 应用程序.assets/2db9488bf57c4e7.png)

### 保存项目到指定目录

![img](05.第一个 Spring Boot 应用程序.assets/d997c6995fd0121.png)
